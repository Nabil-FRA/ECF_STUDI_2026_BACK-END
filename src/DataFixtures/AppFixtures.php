...
public function __construct(UserPasswordHasherInterface $hasher, MongoDbService $mongoDbService)
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $admin->setPassword($this->hasher->hashPassword($admin, 'QYxNxJ56HtSyFd@C'));
        ...
        $employe->setPassword($this->hasher->hashPassword($employe, 'i9fXPNdekBs%ZvEY'));
        ...
        $client1->setPassword($this->hasher->hashPassword($client1, 'a6quM%N3jAxtRQ!W'));
